...
SECRET_KEY = 'kwwc-&p(i!xy)1iup)-v%4&0c_#$=somwt&=*eb7(u293n3)_p'
...
EMAIL_HOST_USER = "tc670611@gmail.com"
EMAIL_HOST_PASSWORD = "1bermuda"
EMAIL_PORT = 587
EMAIL_USE_TLS = True
...
#Settings for registration redux               # If True, users can register
ACCOUNT_ACTIVATION_DAYS = 7     # One-week activation window; you may, of course, use a different value.
REGISTRATION_AUTO_LOGIN = True  # If True, the user will be automatically logged in.
LOGIN_REDIRECT_URL = '/advisingApp/base'  # The page you want users to arrive at after they successful log in
